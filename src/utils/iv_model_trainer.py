...
class IVModelTrainer:
    ...
    def __init__(self,
        ...
        if self.loss_function is None:
            raise ValueError("loss_function must be provided. Import from src.models.loss_functions")
    ...
    def train_one_epoch(self, train_loader, **epoch_kwargs) -> float:
        ...
        for batch in train_loader:
            # Unpack batch - handle variable batch formats
            ...
            # Compute loss using function pointer
    ...
    def evaluate(self, test_loader, scalers, include_plots: bool = True) -> Tuple[float, List]:
        """
    ...
    def _unpack_batch(self, batch) -> Dict[str, torch.Tensor]:
        ...
        return {
            ...
            'eos_targets': eos_targets.to(self.device) if eos_targets is not None else None
        }
